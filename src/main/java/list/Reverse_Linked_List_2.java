...
public class Reverse_Linked_List_2 {
    ...
    static class TwoPass {
        public static list.ListNode reverseBetween(list.ListNode head, int m, int n) {

            if (head == null || head.next == null) return head;
            if (m == n) return head;

            list.ListNode mNode , mNodeBefore , nNode , nNodeAfter;
            mNode = mNodeBefore = nNode = nNodeAfter = null;

            list.ListNode p = head;
            int count = 1;
    ...
    static class OnePass {
        ...
        public static list.ListNode reverseBetween(ListNode head, int m, int n) {
